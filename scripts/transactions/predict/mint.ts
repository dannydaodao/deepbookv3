...
const ORACLE_SVI_ID = '0x169c5df118f4655fcb6404bd8e1d328f0bf0789855c7511236a48d936b4f01e3'; 

// 设定你的投注参数
const STRIKE_PRICE = 69200n * 1_000_000_000n; // 假设行权价 65000，注意是否需要乘以 1e9 scaling
...
(async () => {
    ...
    const ORACLE_EXPIRY = 1780398900000n; // 替换为真实的预言机到期时间
